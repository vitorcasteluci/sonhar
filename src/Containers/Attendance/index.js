  ...
  return (
    <div>
      ...
      instituto. Atendemos cerca de 203 (duzentos e três) crianças e mulheres em curso, todas de baixa renda,
        ...
        <Text>sendo 168 pessoas em fila de espera.</Text>
        <Text>A expectativa é o atendimento de 6000 pessoas ao ano, a maioria meninas e mulheres em</Text>
        <Text>situação de abandono emocional por parte da família, que tenham sofrido violência por parte de familiar</Text> 
        <Text>ou vizinho (perfil traçado de acordo com os casos já existentes na história do instituto). </Text>
        <Text>Em média já passaram mil pessoas pelo instituto. As crianças chegam até nós por meio de </Text>
        <Text>indicação dos conselhos tutelares, ministério público, CRAS, redes sociais, e-mails ou indicação de um</Text>
        <Text>outro psicólogo.</Text>
        <Text>Atendemos meninos na faixa etária de 6 (seis) a 13 (treze) anos; meninas de 2 (dois) a 16</Text>
        <Text>(dezesseis) anos e mulheres de 22 a 58 anos (Não possuímos restrição de idade, dados fornecidos apenas</Text>
        <Text>para fins estatísticos)</Text>
      </MainText>
      </TextWrapper>
      </Main>
      <NumberDiv>
        ...
        <NumberGraph><img src={numGraph} alt="graph"></img></NumberGraph>
        <NumberText>
        ...
        <NumberGraph><img src={pizzaGraph} alt="pizza"></img></NumberGraph>
      </NumberDiv>
